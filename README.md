...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ocean_data_gateway-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12948&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ocean_data_gateway-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ocean_data_gateway` can be installed with:

```
conda install ocean_data_gateway
```

It is possible to list all of the versions of `ocean_data_gateway` available on your platform with:
